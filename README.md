...
3) If you use [yubicyrpt](https://github.com/Ch1ffr3punk/yubicrypt) as a modern replacement for OpenPGP  
you may appreciate that mfv supports the .well-known/yubicrypt/ directory  
where you can store yubicrypt encryption certificates along with their respective .ots files.  
